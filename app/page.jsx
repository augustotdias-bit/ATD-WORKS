...
export default function Home(){
  ...
  return <main className="site">
    ...
    <section className="hero"><p className="eyebrow">Personal artwork archive</p><h1>ATD<br/>WORKS</h1><p>An evolving catalogue of artworks. Each work is documented with its title, medium, dimensions, date, price and availability, with the original uploaded image kept available for download.</p></section>
